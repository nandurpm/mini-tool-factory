...
- [x] Define a safe declarative JSON schema for controlled calculator and unit-conversion tool specifications.
- [x] Build deterministic prompt templates that produce validated tool definitions without executing generated code.
- [x] Implement a controlled calculator runtime, specification validation, and invalid-specification rejection.
