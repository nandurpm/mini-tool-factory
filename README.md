...
```bash
git clone https://github.com/nandurpm/mini-tool-factory.git
cd mini-tool-factory
pnpm install
```
...
**Live URL:** [https://mini-tool-factory.onrender.com](https://mini-tool-factory.onrender.com)
...
| [`src/`](src/README.md) | Contains the production implementation of Mini Tool Factory: command handling, domain rules, storage, reports, and local serving as applicable. |
| [`tests/`](tests/README.md) | Contains automated regression tests for Mini Tool Factory's public behavior and important safety constraints. |
...
- [`src/README.md`](src/README.md) — Contains the production implementation of Mini Tool Factory: command handling, domain rules, storage, reports, and local serving as applicable.
- [`tests/README.md`](tests/README.md) — Contains automated regression tests for Mini Tool Factory's public behavior and important safety constraints.
